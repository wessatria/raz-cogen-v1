...
- `docs/Customer_Budget_Cogen_Proposal_Template.txt`
- `docs/PRD_Raz_Cogen.txt`
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "221095868+wessatria@users.noreply.github.com"
  git config user.name "wessatria"
  ```
